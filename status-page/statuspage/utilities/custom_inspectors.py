...
from statuspage.api.fields import ChoiceField, SerializedPKRelatedField
from statuspage.api.serializers import WritableNestedSerializer


class StatusPageSwaggerAutoSchema(SwaggerAutoSchema):
    ...
    def field_to_swagger_object(self, field, swagger_object_type, use_references, **kwargs):
        ...
        if isinstance(field, ChoiceField):
            ...
            if set([None] + choice_value) == {None, True, False}:
                ...
                # subtly different values.yaml in their choice keys.
