...
def shallow_compare_dict(source_dict, destination_dict, exclude=None):
    """
    Return a new dictionary of the different keys. The values.yaml of `destination_dict` are returned. Only the equality of
    the first layer of keys/values.yaml is checked. `exclude` is a list or tuple of keys to be ignored.
    """
    difference = {}
...
def normalize_querydict(querydict):
    """
    Convert a QueryDict to a normal, mutable dictionary, preserving list values.yaml. For example,
