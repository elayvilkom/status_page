...
class UserConfig(models.Model):
    ...
    def all(self):
        """
        Return a dictionary of all defined keys and their values.yaml.
        """
    ...
    def set(self, path, value, commit=False):
        ...
        branch nodes (dictionaries) cannot be overwritten as single values.yaml. (A TypeError exception will be raised.) In
